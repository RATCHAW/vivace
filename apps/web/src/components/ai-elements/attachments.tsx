      ...
      <div
        className={cn(
          ...
          variant === "inline" && [
            ...
            "border-border rounded-full border px-2",
...
// Base UI's PreviewCard carries its open/close delays on the trigger, not the
// root, so the registry's openDelay/closeDelay props have nowhere to go here.
